    ...
    <div className="col-12 container">
      <div className="row" id="buttonsRow">
        ...
        <div id="menuButtonWrapper" className="col-md-8 d-flex flex-row justify-content-between">
          <Link to="/waitingRoom" type="button" role="button" className="btn menu-btn menu-btn-color d-flex align-items-center justify-content-center">
            Új Játék Indítása
          </Link>
          <div className="dropdown menu-btn">
            ...
            <div className="dropdown-menu w-100" aria-labelledby="joinRoomBtn">
              <div className="d-flex flex-column pl-3 pr-3 pt-2 pb-2">
                ...
                <Link to="/lobby" role="button" id="connectButton" className="btn btn-success w-50 m-auto d-flex align-items-center justify-content-center">Csatlakozás</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row" id="rulesRow">
        ...
        <div id="rules" className="col-md-8 card p-0">
          <div className="card-body overflow-auto">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://www.ketaklub.hu/letoltes/Stratego%20Aoriginal%20Piatnik.pdf">(Részletes szabály leírás)</a>
          </div>
        </div>
        <div className="col-md-2"></div>
      </div>
